...
// Generated 11-Jul-2021 17:36:44
...
#include "trajectory_07_05_2021_real.h"
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"trajectory_07_05_2021_real\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(trajectory_07_05_2021_real_M, (NULL));
        trajectory_07_05_2021_real_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(trajectory_07_05_2021_real_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(trajectory_07_05_2021_real_M)
                == (NULL)) || rtmGetStopRequested(trajectory_07_05_2021_real_M));
    ...
    void NodeInterface::terminate(void)
    {
      if (mBaseRateThread.get()) {
        ...
        trajectory_07_05_2021_real_terminate();
        mNode.reset();
      }
    }
    ...
    {
      mRunModel = (rtmGetErrorStatus(trajectory_07_05_2021_real_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
        ...
        if (!mRunModel)
          break;
        trajectory_07_05_2021_real_step();
